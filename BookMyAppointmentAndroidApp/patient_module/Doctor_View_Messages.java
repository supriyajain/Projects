...
public class Doctor_View_Messages extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		setContentView(R.layout.activity_doctor__view__messages);
		...
		if (cu != null && cu.getBoolean("emailVerified")) 
		{
			...
			final ListView l=(ListView)findViewById(R.id.docviewmsgList);
			...
			final ArrayList<ArrayList<String>> unreadmsglist=fm.fetch_Message(docemail, 0);
				...
				for(ArrayList<String> a: unreadmsglist)
				{
					...
					try
					{
						...
						if(o!=null)
						{
							...
							String name=patname+" "+a.get(2)+" "+a.get(3);
							msglist.add(name);
						}
					}
			...
			{
				Toast.makeText(Doctor_View_Messages.this, "No New Message !", 0).show();
			}
			...
			l.setOnItemClickListener(new OnItemClickListener()
			{
						...
						final int arg2, long arg3) 
				{
					if(arg2==0)
					{
						Intent ihome=new Intent(Doctor_View_Messages.this,Doctor_Home.class);
						startActivity(ihome);
					}
					else if(arg2==1)
					{
						...
						final ArrayList<ArrayList<String>> readmsglist=fm1.fetch_Message(docemail, 1);
							...
							for(ArrayList<String> a1: readmsglist)
							{
								...
								try
								{
									...
									if(o!=null)
									{
										...
										String name=patname+" "+a1.get(2)+" "+a1.get(3);
										msglist1.add(name);
									}
								}
								catch(ParseException e)
						...
						{
							Toast.makeText(Doctor_View_Messages.this, "No message to display !!", 0).show();
						}
						
						final ListView l1=(ListView)findViewById(R.id.docviewmsgList); 
						ArrayAdapter<String> ad2=new ArrayAdapter<String>(Doctor_View_Messages.this, android.R.layout.simple_list_item_1,msglist1);
						l1.setAdapter(ad2);
						...
						l1.setOnItemClickListener(new OnItemClickListener()
						{
									...
									final int arg2, long arg3) 
							{
								if(arg2==0)
								{
									Intent ihome1=new Intent(Doctor_View_Messages.this,Doctor_Home.class);
								...
								else
								{
									...
									AlertDialog.Builder ab2=new AlertDialog.Builder(Doctor_View_Messages.this);
									...
									ab2.setNeutralButton("Delete", new DialogInterface.OnClickListener() 
									{
										...
										{
											AlertDialog.Builder ab3=new AlertDialog.Builder(Doctor_View_Messages.this);
											...
											ab3.setPositiveButton("Yes", new DialogInterface.OnClickListener() 
											{
												...
												public void onClick(DialogInterface dialog, int which) 
												{
													...
													ArrayAdapter<String> ad3=new ArrayAdapter<String>(Doctor_View_Messages.this, android.R.layout.simple_list_item_1,msglist1);
													l1.setAdapter(ad3);
												}
											});
									...
									ab2.setNegativeButton("Block User", new DialogInterface.OnClickListener()
									{
										...
										public void onClick(DialogInterface dialog, int which) 
										{
											...
											ibu1.save_block_user(docemail, readmsglist.get(selected1).get(0));
											Toast.makeText(Doctor_View_Messages.this, "User has been blocked !!\nYou will not receive any message from this user in future !!", 0).show();
										}
									});
									ab2.show();
								}
					...
					else
					{
						...
						AlertDialog.Builder ab1=new AlertDialog.Builder(Doctor_View_Messages.this);
						...
						ab1.setPositiveButton("OK", new DialogInterface.OnClickListener()
						{
							...
							{
								Messages ums=new Messages();
								ums.Flag_Update(unreadmsglist.get(selected).get(0), docemail, unreadmsglist.get(selected).get(2), unreadmsglist.get(selected).get(3));
								unreadmsglist.remove(selected);
								msglist.remove(arg2);
								ArrayAdapter<String> ad1=new ArrayAdapter<String>(Doctor_View_Messages.this, android.R.layout.simple_list_item_1,msglist);
								l.setAdapter(ad1);
							}
						});
						ab1.setNeutralButton("Delete", new DialogInterface.OnClickListener() 
						{
							...
							public void onClick(DialogInterface dialog, int which) 
							{
								AlertDialog.Builder ab4=new AlertDialog.Builder(Doctor_View_Messages.this);
								...
								ab4.setPositiveButton("Yes", new DialogInterface.OnClickListener() 
								{
									...
									public void onClick(DialogInterface dialog, int which) 
									{
										...
										unreadmsglist.remove(selected);
										msglist.remove(arg2);
										ArrayAdapter<String> ad3=new ArrayAdapter<String>(Doctor_View_Messages.this, android.R.layout.simple_list_item_1,msglist);
										l.setAdapter(ad3);
									}
								});
						...
						ab1.setNegativeButton("Block User", new DialogInterface.OnClickListener()
						{
							...
							public void onClick(DialogInterface dialog, int which) 
							{
								...
								ibu.save_block_user(docemail, unreadmsglist.get(selected).get(0));
		...
		{
			Intent i2=new Intent(Doctor_View_Messages.this, MainActivity.class);
			startActivity(i2);
		}
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.activity_doctor__view__messages, menu);
		return true;
	}
